...
if __name__ == '__main__':
  ...
  produce_scatterplot(ytest, ypred, xlab='Actual day cases', ylab='Predicted day cases', filename='lr_pred.png', line=True)
  produce_hist(ypred / ytest, 'Predicted to Actual Ratios', xlab='Predicted to Actual case count ratio', ylab='Frequency', filename='lr_ratio.png')
  produce_lineplot(ytest, ypred, 'Actual', 'Predicted', xlab='Day', ylab='Number of Cases', filename='lr_trend.png')
